<?php
	        	...
	        	if ( is_use_weixin()) {
				   ...
				   if(CUSTOM_VERSION==true&&is_file(CUSTOM_ROOT.'/common/extends/class/shopwap/class/mobile/shopindex_2.php'))
			{
  			require(CUSTOM_ROOT.'/common/extends/class/shopwap/class/mobile/shopindex_2.php');
				}