	 	...
	 	if($op=='post')
       	{
       		...
       		if(intval($_GP['tostatus'])==-1)
       		{
       		 	...
       		 	require(WEB_ROOT.'/system/common/extends/class/shop/class/web/outchargegold_1.php');	
       		}else
       		{
       			 	require(WEB_ROOT.'/system/common/extends/class/shop/class/web/outchargegold_2.php');
