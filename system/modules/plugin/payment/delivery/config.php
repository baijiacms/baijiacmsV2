...
<h3 class="header smaller lighter blue">货到付款</h3>
<form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
      <div class="form-group">
		 ...
		 <div class="form-group">
										...
										<div class="col-sm-9">
													 	<textarea name="delivery_pay_desc" id="delivery_pay_desc" cols="60" rows="8"><?php  echo $configs['delivery_pay_desc'];?></textarea>
										</div>
									</div>
...
<script type="text/javascript">var ue = UE.getEditor('delivery_pay_desc');</script>