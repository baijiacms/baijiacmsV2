...
mysqld_update('payment',array('order' => $_GP['pay_order'],'configs'=> serialize($pay_submit_data)) , array('code' => 'unionpay'));
	mysqld_update('payment', array('enabled' => '1') , array('code' => 'unionpay'));
?>