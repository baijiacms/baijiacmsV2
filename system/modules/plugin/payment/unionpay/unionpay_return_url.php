...
$payment = mysqld_select("SELECT * FROM " . table('payment') . " WHERE  enabled=1 and code='unionpay' limit 1");
		...
		$orderid=$_POST['reqReserved'];
			...
			if(empty($index))
	      	...
	      	mysqld_insert('paylog_unionpay', $paylog_unionpay);
										mysqld_insert('paylog', array('typename'=>'支付成功1','pdate'=>$post_data,'ptype'=>'success','paytype'=>'unionpay'));
										}else
										{
	      	...
	      	mysqld_insert('paylog_unionpay', $paylog_unionpay);
										mysqld_insert('paylog', array('typename'=>'支付成功','pdate'=>$post_data,'ptype'=>'success','paytype'=>'unionpay'));
	      	...
	      	mysqld_insert('paylog_unionpay', $paylog_unionpay);
										...
										mysqld_insert('paylog', array('typename'=>'未找到相关订单','pdate'=>$post_data,'ptype'=>'error','paytype'=>'unionpay'));
					    echo 'fail';
			    exit;
									}
	      	...
	      	mysqld_insert('paylog_unionpay', $paylog_unionpay);
								...
								mysqld_insert('paylog', array('typename'=>'余额充值成功','pdate'=>$post_data,'ptype'=>'success','paytype'=>'unionpay'));
	      	...
	      	mysqld_insert('paylog_unionpay', $paylog_unionpay);
										...
										mysqld_insert('paylog', array('typename'=>'余额充值未找到订单','pdate'=>$post_data,'ptype'=>'error','paytype'=>'unionpay'));
					    echo 'fail';
			    exit;
									}
...
{
							mysqld_insert('paylog', array('typename'=>'支付失败','pdate'=>$post_data,'ptype'=>'error','paytype'=>'unionpay'));
}
echo 'fail';
    exit;