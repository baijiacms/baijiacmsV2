			...
			<tbody>
				...
				<tr>
					<td style="text-align:center;">
						<input id="s<?php echo $index;$index++?>" type="checkbox" name="<?php  echo $item['modname'].'-'.$item['moddo'];?>" value="1"  <?php echo $item['check']==true?"checked":""?>>
						</td>
...
<td style="text-align:center;"><span class="label label-success">系统模块</span></td>
				...
				<tr>
					<td style="text-align:center;">
						...
						<input id="s<?php echo $index;$index++?>" type="checkbox" name="<?php  echo $item['name'].'-ALL';?>" value="1"  <?php echo $item['check']==true?"checked":""?>>
						</td>
